      ...
      <section className="space-y-3">
        ...
        <ol className="space-y-3 text-sm text-muted-foreground">
          <li className="flex gap-3">
            ...
            <span><strong className="text-foreground">Register</strong> at <Link href="/dashboard/keys" className="underline">swor.io/register</Link> and choose a plan. Free plan gives you 10,000 chars/month immediately.</span>
          </li>
          <li className="flex gap-3">
